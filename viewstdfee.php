...
<body>
                ...
                <!-- /.row -->
                    ...
                    <div class="col-lg-6">
									<div>
									  ...
									  <li role="presentation" class="active"><a href="viewstdfee.php">View Paid Students</a></li>
									  <li role="presentation"><a href="viewstdfeeunpaid.php">View Unpaid Students</a></li>
									  </ul>
									</div>
									  <br>
				 ...
				 <button type="button" class="btn btn-default btn-primary" onClick="viewfeemonth()">Submit</button>
						...
						<br>
                                 	 ...
                                 	 <select class="form-control" name="group" id="group" onChange="callfee_1(this.value)">
    ...
    <script src="js/plugins/morris/morris-data.js"></script>
	  ...
	  <script>
			...
			var enddate=document.getElementById("enddate").value;
				if(stdate<=enddate){
					  ...
					  xmlhttp.onreadystatechange = function(){
						...
						xmlhttp.open("GET","stdfeemonth.php?stdate="+stdate+"&enddate="+enddate,true);
						xmlhttp.send(null);					
		...
		function callfee_1(p){
			...
			var xmlhttp;
			  ...
			  xmlhttp.onreadystatechange = function(){
				...
				if(stdate!="" && enddate!=""){
					xmlhttp.open("GET","changecontent_feemonth.php?a="+p+"&stdate="+stdate+"&enddate="+enddate,true);
				}
				else{
					xmlhttp.open("GET","changecontent_fee.php?a="+p,true);
				}
				xmlhttp.send(null);
			} 
		...
		if(stdate=="" && enddate==""){
			xmlhttp.open("GET","changecontent2_fee.php?b="+q+"&a="+p,true);
		}
		else{
			xmlhttp.open("GET","changecontent2_feemonth.php?b="+q+"&a="+p+"&stdate="+stdate+"&enddate="+enddate,true);
        }
		xmlhttp.send(null);
        }
		}
