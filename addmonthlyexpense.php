...
<body>
  ...
  <li role="presentation" class="dropdown" >
    ...
    <ul class="dropdown-menu" role="menu" >
    	  <li><a href="addmonthlyexpense.php">Add Monthly Expenses</a></li>
            <li><a href="managemonthlyexpense.php">Manage Monthly Expenses</a></li>
   ...
   <li role="presentation" class="dropdown">
    ...
    <ul class="dropdown-menu" role="menu">
    	  <li><a href="#">Add Teacher Salary</a></li>
            <li><a href="#">Manage Teacher Salary</a></li>
          <li><a href="#">View Teacher Salary</a></li>
