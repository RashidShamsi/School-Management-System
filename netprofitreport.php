                  ...
                  <p>
						  Select Start And End Date<br>
							...
							<input type="date" name="stdate" id="stdate">
							 End Date:
							<input type="date" name="endate" id="enddate">
							<input type="button" value="view" onClick="netreportfunction1(document.getElementById('stdate').value, document.getElementById('enddate').value)">
...
function slip_print(){
	...
	document.getElementById("tab1").style.fontSize="12px";
	document.getElementById("tab2").style.fontSize="12px";
	document.getElementById("tab3").style.fontSize="12px";
	document.getElementById("tab4").style.fontSize="12px";
	document.getElementById("tab5").style.fontSize="12px";
	document.getElementById("tab6").style.fontSize="12px";
	document.getElementById("tab7").style.fontSize="12px";
...
*/	
	window.location.href = 'netprofitreport.php';
}
