...
<div id="page-wrapper">
	...
	<input type="button" class="btn btn-primary btn-default" value="view" onClick="incomereportfunction1(document.getElementById('stdate').value, document.getElementById('enddate').value)">
				</div>		 
...
/*	
	...
	document.getElementById("tab1").style.fontSize="initial";
	document.getElementById("tab2").style.fontSize="initial";
*/
	window.location.href = 'incomereport.php';
}
