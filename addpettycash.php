    ...
    <div class="input-group">
      ...
      <span class="input-group-btn">
        <button class="btn btn-default" type="button">Go!</button>
              ...
              <button type="submit" class="btn btn-default">Add Petty Cash</button>
              <button type="reset" class="btn btn-default">Manage Petty Cash</button>
              <button type="reset" class="btn btn-default">View Petty Cash</button>
