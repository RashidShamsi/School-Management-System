        ...
        <button class="btn btn-default" type="button">Go!</button>
                ...
                <!-- /.row -->
                  <div class="row">
                        ...
                        <form role="form" action="edit_managepcash_2.php" method="post" >

                           
                             <div class="form-group">
                            
                                <label>Voucher Id</label>
                                <input class="form-control" id="voucherid" name="voucherid" value="<?php print($row['pcash_voucher_id']); ?>"S>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" id="amount" name="amount" value="<?php print($row['issuedamount']); ?>"required>
                                <p class="help-block"></p>
                            </div>
                           
                            <div class="form-group">
                                <label>Descreption</label>
                                <input class="form-control"  id="reason" name="reason" value="<?php print($row['reason']); ?>"required>
                                <p class="help-block"></p>
                            </div>
