...
$query="select * from teacher_salary WHERE teacher_id='$id' AND month='$month'";
$result = mysql_query($query) or die(mysql_error());
if(mysql_num_rows($result)){
	while($row=mysql_fetch_array($result, MYSQL_BOTH)){
		$month1=$row['month'];
		...
		$voucher=$row['tsalary_voucher_id'];
	}
}
...
?>						
			...
			<div class="panel panel-default" align="center">
									 ...
									 <tr style="background-color:#f5f5f5;">
										<td colspan="8" style="text-align:center;"><b><h3>Teacher's Salary Slip<h3><b></td>
									</tr>
		...
		<tr>
        <td><b>Monthly Salary</b></td><td><?php echo $amount; ?></td>
       </tr>
	   <tr>
        <td><b>Date</b></td><td><?php echo $date; ?></td>
                      ...
                      <div class="col-lg-6">				
								...
								<form action="teacher_salary.php" method="" >  
