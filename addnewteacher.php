...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <form  id="myform" onsubmit="return check_group()" enctype="multipart/form-data" action="submit_teacher.php" method="POST">
							...
							<div class="form-group">
                                <label>CNIC</label>
                                <input class="form-control"  name="cnic" id="cnic" placeholder="CNIC" maxlength="13" required>
                                <p class="help-block"></p>
                            </div>
														
                             <div class="form-group">
                                <label>Address</label>
                                <input class="form-control"  name="address" id="address" placeholder="Karachi" required>
                                <p class="help-block"></p>
                            </div>
                           ...
                           <div class="form-group">
							  ...
							  <div class="form-group">
                                ...
                                <input class="form-control"  name="phonenumber" id="phonenumber" placeholder="0333-1234567" required>
                                <p class="help-block"></p>
                            </div>
							...
							<div class="form-group">
                                <label>Email</label>
                                <input class="form-control"  name="email" id="email" placeholder="masab@gmail.com">
                                <p class="help-block"></p>
                            </div>
                         ...
                         <input type="checkbox" name="group[]" value="<?php print($row['group_id']); ?>" id="<?php print($row['group_id']); ?>"/><?php print($row['group_name']); ?><br/>
													
													<?php }
														}
													?>	
													  <button type="submit" class="btn btn-default">Select Groups</button>
	...
	<script>
		...
		function check_group(){
			var a="";
			for(b=1;b<8;b++){
			var x=document.getElementById("00"+b);
				if(x.checked){
					a=1;
				}
			}
