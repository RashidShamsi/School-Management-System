...
<body>
  ...
  <li role="presentation"  class="active"><a href="viewpettycash.php">View Petty Cash</a></li>
  </ul>
  </div>
                ...
                <!-- /.row -->
                        ...
                        <form>
                          ...
                          <input type="button" value="view" onClick="viewpettycashfunction(document.getElementById('stdate').value, document.getElementById('enddate').value)">
                        </form>
