...
<body>
 ...
 <form action="subjstdfee.php" method="POST">

  <div class="form-group">
                                <label>Enter admission fee</label>
                                <input class="form-control"  placeholder="Enter fee..." name="admfee" id="admfee" required>
 ...
 for ($i=0; $i<sizeof($subjects); $i++)
        ...
        ?>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control"  placeholder="Enter fee..." name="subfee[]" id="subfee" required>
                                <p class="help-block"></p>
                            </div>
