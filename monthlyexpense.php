  ...
  <li role="presentation" class="dropdown" >
   ...
   <li role="presentation" class="dropdown">
    ...
    <ul class="dropdown-menu" role="menu">
          ...
          <li><a href="teacher_salary.php">View Teacher Salary</a></li>
                ...
                <!-- /.row -->
                        ...
                        <form role="form" action="submit.php" method="get" >
                          ...
                          <div class="form-group">
                                ...
                                <input type="month" class="form-control"  id="months" name="month" onChange="monthlyexpensefunction1(this.value)"required>
