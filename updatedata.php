...
<body>
	...
	if(mysql_num_rows($result)){
		while($row=mysql_fetch_array($result)){							
			$groupteacherid[]=$row['group_id'];
			$groupteachername[]=$row['group_name'];
		}
	}
...
<div class="row">
<div class="col-lg-6">
											<form role="form" action="updateteacher.php" method="POST" enctype="multipart/form-data">
							
													<input type="hidden" name="id" size="50" value="<?php echo $id?>" ></td>
													<div class="form-group">
														<label>ID</label>
														<input class="form-control" name="id" value="<?php echo $id?>" disabled>
														<p class="help-block"></p>
													</div>
													<div class="form-group">
														<label>Name</label>
														<input class="form-control" type="text" name="name" size="50" value="<?php echo $name?>" required>
														<p class="help-block"></p>
													</div>
													<div class="form-group">
														<label>CNIC</label>
														<input class="form-control" type="text" name="cnic" size="13" value="<?php echo $cnic; ?>" required>
														<p class="help-block"></p>
													</div>
													<div class="form-group">
														<label>Address</label>
														<input class="form-control" type="text" name="address" size="50" value="<?php echo $address; ?>" required>
														<p class="help-block"></p>
													</div>
													<div class="form-group">
														<label>Gender</label>
													...
													<div class="form-group">
														...
														<input class="form-control" type="number" name="phonenumber" size="50" value="<?php echo $phonenumber ?>" required>
														<p class="help-block"></p>
													</div>
													<div class="form-group">
														<label>Email</label>
														<input class="form-control" type="email" name="email" size="50" value="<?php echo $email ?>" >
														<p class="help-block"></p>
													</div>
														...
														<?php
															$query="SELECT `group_id`, `group_name` FROM `tbl_group`";
															$result = mysql_query($query) or die(mysql_error());
															if(mysql_num_rows($result)){
																while($row=mysql_fetch_array($result, MYSQL_BOTH)){
											
																foreach($groupteacherid as $value){
									...
									<input type="checkbox" name="group[]" value="<?php print($row['group_id']); ?>" id="<?php print($row['group_id']); ?>" <?php echo @$b ?> /><?php print($row['group_name']); ?><br/>
