  ...
  <form action="teacher_manage_salaryupdate.php" method="GET" >                           
                      <table border="0" align="center">
                          ...
                          <tr>
                              ...
                              <td> <div class="form-group" ><input type="month" onChange="manageteachersalarymonth(this.value,document.getElementById('enr').value)" name="month" class="form-control" required></div></td>
                          </tr>
                          <tr>
