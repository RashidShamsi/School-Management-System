...
<body>
  ...
  <li role="presentation" ><a href="pettycash.php">Add Petty Cash</a></li>
  <li role="presentation" class="active"><a href="managepettycash.php">Manage Petty Cash</a></li>
  <li role="presentation" ><a href="viewpettycash.php">View Petty Cash</a></li>
                ...
                <!-- /.row -->
                        ...
                        <form>
                          ...
                          <input type="button" value="view" onClick="managepettycashfunction(document.getElementById('stdate').value, document.getElementById('enddate').value)">
                        </form>
