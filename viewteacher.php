					   ...
					   <li>
						  ...
						  <ul id="demo" class="collapse">
							  <li>
                               ...
                               <li>
								  <a href="feesummary.php">Fee Summary of Student</a>
							  </li>
							  <li>
                ...
                <!-- /.row -->
                    ...
                    <div class="col-lg-6">
  								 ...
  								 <label>Group</label>
                                 	 ...
                                 	 <select class="form-control" name="group" id="group" onChange="callfunctions1_teacher(this.value)">
														<option value="000">Select Any Program</option>
														<option value="001">Primary</option>
														<option value="006">Computer Science</option>
														<option value="005">Biology</option>
														<option value="002">Pre-Engineering</option>
                                                        <option value="003">Pre-Medical</option>
														<option value="007">General Science</option>
                                                        <option value="008">Commerce</option>
                                ...
                                <select class="form-control" name="subject" id="subject" onChange="callfunctions3_teacher(this.value)">
