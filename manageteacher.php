                ...
                <!-- /.row -->
                    ...
                    <div class="col-lg-6">
  								 ...
  								 <label>Group</label>
                                 	 ...
                                 	 <select class="form-control" name="group" id="group" onChange="manageteacher1(this.value)">
                                ...
                                <select class="form-control" name="class" id="class" onChange="manageteacher2(this.value)" >
                                ...
                                <select class="form-control" name="subject" id="subject" onChange="manageteacher3(this.value)">
...
?>				 	
           							<tr>
                                        ...
                                        data-id="<?php print($row['teacher_id']); ?>" data-target="#myModal">
 Delete
</button></td>
...
?>
	...
	<script>
				...
				function toanotherpage(){
					window.location.href = "deleteteacher.php?id="+userId;
