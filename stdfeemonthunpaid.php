<?php
	...
	$z="";
	  ...
	  $query2="SELECT student_fee.std_enr, student_fee.month, student_fee.monthlyfee, student_fee.admissionfee, student.std_name FROM student INNER JOIN student_fee ON student_fee.std_enr=student.std_enr WHERE month BETWEEN '$stdate' AND '$enddate' AND student_fee.status='UNPAID'";		
