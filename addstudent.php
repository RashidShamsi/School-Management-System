            ...
            <div class="container-fluid">
                ...
                <!-- /.row -->
                    ...
                    <div class="col-lg-6">
                        ...
                        <form  enctype="multipart/form-data" action="stdSubmit.php" method="post">

                            <div class="form-group">
                                <label>Name</label>
                                <input class="form-control"  placeholder="Enter name..." name="name" id="name" required>
                                <p class="help-block"></p>
                            </div>
                            
                             <div class="form-group">
                                <label>Father Name</label>
                                <input class="form-control" name="fname" id="fname" size="50" placeholder="Enter Father's name..." required>
                                <p class="help-block"></p>
                            </div>
                       ...
                       <input type="radio" name="gender" id="male" value="male"  required>Male
                            ...
                            <div class="form-group">
                                <label>Address</label>
                                <input class="form-control"  placeholder="Karachi" name="address" id="address" size="50" required>
                                <p class="help-block"></p>
                            </div>
                            
                            <div class="form-group">
                                <label>Contact Number</label>
                                <input class="form-control"  name="phonenumber" id="phonenumber" size="50"  placeholder="0333-1234567" required>
                                <p class="help-block"></p>
                            </div>
                            ...
                            <div class="form-group">
                                <label>Email</label>
                                <input class="form-control" name="email" id="email" size="50" placeholder="masab@gmail.com">
                            </div>
