...
$pcash_voucher_id=$_GET['v_id'];

$_SESSION['pcash_voucher_id']=$pcash_voucher_id;

	$query="select * from pettycash where pcash_voucher_id=$pcash_voucher_id";
    ...
    <div class="input-group">
                ...
                <!-- /.row -->
                  <div class="row">
                        ...
                        <form role="form" action="delete_managepcash2.php" method="post" >
							<input type="hidden" name="voucherid" value="<?php print($row['pcash_voucher_id']); ?>" >
                           
                             <div class="form-group">
                            
                                <label>Voucher Id</label>
                                <input class="form-control" id="voucherid" name="voucherid" value="<?php print($row['pcash_voucher_id']); ?>"disabled>
                                <p class="help-block"></p>
                            </div>
                             <div class="form-group">
                            
                                <label>Date</label>
                                <input class="form-control" id="date" name="date" value="<?php print($row['date']); ?>"disabled>
                                <p class="help-block"></p>
                            </div>
                            <div class="form-group">
                            	 <label>Issued Amount</label>
                                <input class="form-control" id="amount" name="amount" value="<?php print($row['issuedamount']); ?>"disabled>
                                <p class="help-block"></p>
                            </div>
                           
                            <div class="form-group">
                                <label>Descreption</label>
                                <input class="form-control"  id="reason" name="reason" value="<?php print($row['reason']); ?>"disabled>
                                <p class="help-block"></p>
                            </div>
